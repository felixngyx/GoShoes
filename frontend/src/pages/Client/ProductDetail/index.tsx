...
const ProductDetail = () => {
	...
	const [activeTab, setActiveTab] = useState<'description' | 'reviews' | 'writeComment'>('description');
		...
		<div className="max-w-7xl mx-auto lg:px-0 sm:px-6">
			<div className="grid grid-cols-1 md:grid-cols-12 gap-10">
				...
				<div className="md:col-span-5">
					...
					{/* Size Selection - Phiên bản mới dạng button */}
							...
							{uniqueSizes.map((sizeInfo: any) => {
								...
								return (
									<button
										...
										onClick={() => !isDisabled && handleSizeChange(sizeInfo.size)}
					...
					<div className="space-y-4 border rounded-sm">
						<div className="flex flex-col gap-2">
							...
							<div className="flex items-center gap-2 justify-center mb-2">
								...
								<span className="text-xs text-[#9098B1] line-through">$199.99</span>
							</div>
						</div>
					</div>
				</div>
