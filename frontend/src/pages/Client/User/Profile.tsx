...
const Profile = () => {
  ...
  const { register, handleSubmit, formState: { errors } } = useForm<ProfileParams>({
  ...
  return (
    <div className="col-span-9 gap-10 grid grid-cols-3">
      <div className="p-5 rounded-lg border border-gray-200 shadow-lg col-span-3">
        ...
        <form className="grid grid-cols-2 gap-x-5 gap-y-2" onSubmit={handleSubmit(onSubmit)}>
          <label className="form-control col-span-1">
            ...
            />
            {errors.name && <p className="text-red-500">{errors.name?.message}</p>}  {/* Hiển thị lỗi nếu có */}
          </label>
      ...
      <form className="p-5 rounded-lg border border-gray-200 shadow-lg col-span-1 flex flex-col gap-5">
        ...
        <input type="file" className="file-input file-input-bordered file-input-xs w-fit" />
      ...
      <div className="p-5 rounded-lg border border-gray-200 shadow-lg col-span-2">
        ...
        <form className="grid grid-cols-2 gap-x-5 gap-y-2">
          <label className="form-control col-span-2">
            <div className="label">
              <span className="label-text font-medium text-base">Old password</span>
            </div>
            <input
              type="password"
              placeholder="Type here"
