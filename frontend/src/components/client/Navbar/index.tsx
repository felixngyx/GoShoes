    ...
    <div className="drawer drawer-end sticky top-0 z-50">
      ...
      <div className="drawer-content w-full">
        <div className="bg-white shadow-lg w-full">
          <div className="max-w-7xl mx-auto navbar flex justify-between items-center py-3 px-4">
            ...
            <div className="hidden md:flex">
              <ul className="flex flex-row gap-8 font-semibold text-sm">
                {['HOME', 'BRAND', 'CATEGORY', 'ABOUT US', 'NEWS', 'CONTACT'].map((item) => (
                  <li key={item}>
                    <Link
              ...
              <ul className="flex flex-col gap-2 p-4">
                {['HOME', 'BRAND', 'CATEGORY', 'ABOUT US', 'NEWS', 'CONTACT'].map((item) => (
                  <li key={item}>
                    <Link
                      to={item === 'HOME' ? '/' : `/${item.toLowerCase().replace(' ', '-')}`}
                      className="block py-2 px-4 text-sm font-semibold hover:bg-gray-100 rounded-lg transition-all duration-300"
      ...
      <div className="drawer-side">
        ...
        <div className="bg-white shadow-lg w-[80%] md:w-[35%] h-screen overflow-y-auto p-6 rounded-l-xl">
          ...
          <div className="mt-4">
            {debouncedSearchTerm ? (
              <>
                <p className="text-lg font-semibold text-gray-700">Top suggestions</p>
              ...
              <>
                <p className="text-lg font-semibold text-gray-700">Popular search terms</p>
                <div className="flex flex-wrap gap-2 mt-2">
                  {['Nike', 'Adidas', 'Puma', 'Reebok', 'New Balance'].map((term) => (
                    <button
                      key={term}
            ...
            <div className="mt-4">
              {loading ? (
                ...
                <>
                  <h2 className="text-2xl font-bold text-gray-900 mb-4">Product Suggestions</h2>
