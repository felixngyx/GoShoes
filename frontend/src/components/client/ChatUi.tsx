  ...
  return (
    <div className="fixed bottom-4 right-4 z-50">
      <button
        ...
        className={`p-4 rounded-full bg-blue-600 text-white shadow-lg hover:bg-blue-700 transform transition-all duration-300 ease-in-out ${isOpen ? 'scale-0 opacity-0' : 'scale-100 opacity-100 flex items-center gap-2'
          }`}
      >
        <MessageSquare className="w-6 h-6" />
        <span className="hidden md:inline">Chat với GoShoes</span>
      </button>

      {(isOpen || isClosing) && (
        <div
          className={`transform transition-all duration-300 ease-in-out ${isClosing
          ...
          <div className="w-80 md:w-96 h-[500px] bg-white rounded-lg shadow-xl flex flex-col">
            <div className="p-4 bg-blue-600 text-white rounded-t-lg flex justify-between items-center">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-medium">Hỗ trợ GoShoes trực tuyến</h3>
              </div>
              <button
                onClick={handleClose}
              ...
              {messages.map((msg) => (
                ...
                >
                  ...
                  <div className="flex flex-col max-w-[75%]">
                    <div
                      className={`p-3 rounded-lg transform transition-all duration-200 hover:scale-[1.02] ${msg.sender === 'user'
